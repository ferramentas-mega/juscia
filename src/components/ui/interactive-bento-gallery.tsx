        ...
        <>
            ...
            >
                <div className="h-full flex flex-col">
                    <div className="flex-1 p-2 sm:p-3 md:p-4 flex items-center justify-center bg-muted/50">
                        <AnimatePresence mode="wait">
                            <motion.div
                                ...
                                onClick={onClose}
                            >
                                <MediaItem item={selectedItem} className="w-full h-full object-contain bg-background/20" onClick={onClose} />
