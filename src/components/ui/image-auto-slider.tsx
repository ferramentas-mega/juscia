...
export const ImageAutoSlider: React.FC<ImageAutoSliderProps> = ({ 
  ...
  return (
    <>
      ...
      <div className={`w-full bg-background relative overflow-hidden flex items-center justify-center ${className}`}>
        {/* Background gradient */}
      ...
      <Dialog open={!!selectedImage} onOpenChange={() => setSelectedImage(null)}>
        <DialogContent className="max-w-4xl w-full p-0 bg-transparent border-none shadow-none outline-none ring-0 focus:outline-none focus:ring-0 [&>button]:hidden">
          <button 
            onClick={() => setSelectedImage(null)}
            className="absolute -top-12 right-0 z-50 p-2 hover:opacity-70 transition-opacity focus:outline-none"
            aria-label="Fechar imagem"
          >
            <X className="w-10 h-10 text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]" strokeWidth={2.5} />
          </button>
          {selectedImage && (
            <img
              src={selectedImage}
