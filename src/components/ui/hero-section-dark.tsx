              ...
              <div className="items-center justify-center gap-x-3 space-y-3 sm:flex sm:space-y-0">
                ...
                {secondaryCtaText && (
                  <a
                    ...
                    className="inline-flex rounded-full text-center group items-center justify-center text-gray-900 dark:text-white border border-gray-300 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all py-4 px-10"
                  >
                    {secondaryCtaText}
                  </a>
                )}
