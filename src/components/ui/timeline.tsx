...
export const Timeline = ({
  ...
  return <div className="w-full bg-background font-sans md:px-10" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10 flex flex-col items-center">
        <h2 className="text-2xl md:text-4xl font-bold mb-4 text-primary max-w-4xl text-center">
          Como funciona a Juscia
        </h2>
        <p className="text-muted-foreground text-xs md:text-sm max-w-md text-center">
          Conheça a jornada de transformação do atendimento jurídico com
